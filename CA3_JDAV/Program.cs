    ...
    class Program
    {
        ...
        static void Modica()
        {
            ...
            while (CL != 1)
            {
                ...
                Console.Clear();
                Console.WriteLine("-* Librería el Buen Lector  *-*");
                Console.WriteLine("Ha elegido modificar los libros");
                Console.WriteLine("Digite el id del libro que se desea editar");
                ID = int.Parse(Console.ReadLine());
                ...
                for (i = 0; i < Books.Length; i++)
                {
                    if (ID == Books[i].bookid)
                    {
                        aux = i + 1;
                        Console.WriteLine("ID:       " + Books[i].bookid);
                        Console.WriteLine("Ha escogido editar la informacion de :  " + Books[i].bookname);
                        Console.WriteLine("Digite el nuevo nombre");
                        neo = Books[i].bookname = Console.ReadLine();

                        Console.WriteLine(" Autor Anterior:     " + Books[i].author);
                        Console.WriteLine("Digite el nuevo autor");
                        neo2 = Books[i].author = Console.ReadLine();

                        Console.WriteLine("Precio Anterior :   " + Books[i].bookprice);
